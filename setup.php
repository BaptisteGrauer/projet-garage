...
<html>
    ...
    <body>
        ...
        <section class="contenu">
            ...
            <p>Ensuite, accédez à l'interface des requêtes SQL sur votre serveur, collez ces 4 requêtes SQL et exécutez les requêtes :</p>
                ...
                <p>S'il n'y a pas eu d'erreur, vous pouvez normalement vous connecter avec le compte 'admin' (avec comme mot de passe 'admin') sur le site. <br />
                Je vous recommande vivement de changer le mot de passe du compte 'admin' dès votre première connexion dessus. <br /></p>
