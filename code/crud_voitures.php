...
function read_voiture_id($id, $bdd)
{
...
function read_all_voiture($bdd) // affiche toutes les voitures disponibles à la réservation dans la bdd
{
...
function read_all_voiture_complete($bdd) // affiche toutes les voitures disponibles à la réservation dans la bdd
{
...
function read_6_voiture_random($bdd) // affiche 6 voitures choisies aléatoirement dans la bdd avec mise en forme HTML
{
...
function read_all_voiture_text_categorie($categorie, $bdd) // affiche les trois dernières voitures ajoutées à la bdd avec mise en forme HTML
{
...
function read_3_voiture_last($bdd) // affiche les trois dernières voitures ajoutées à la bdd avec mise en forme HTML
{
...
function update_voiture_reservation($id_voiture, $etat_reservation, $bdd)
{
...
function delete_voiture($id_voiture, $bdd)
{
